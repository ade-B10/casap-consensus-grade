...
#
# Usage:
#   1. Put the updated unencrypted file at source/Casap_Consensus_Grade.html
...
SOURCE_FILE="source/Casap_Consensus_Grade.html"
OUTPUT_FILE="index.html"
LABEL="Base10 · Casap Consensus Grade"
INSTRUCTIONS="Enter the password to access Base10 · Casap Consensus Grade."
REMEMBER_DAYS=14
...
if [ ! -f "$SOURCE_FILE" ]; then
  ...
  echo "  mkdir -p source"
  echo "  cp /Users/ade/Desktop/Urizen/Casap_Consensus_Grade.html source/"
  echo ""
  exit 1
fi
...
sed -i.bak "s|<title>Protected Page</title>|<title>Base10 · Casap Consensus Grade</title>|" "$OUTPUT_FILE"
...
echo "  git commit -m \"Refresh Base10 · Casap Consensus Grade ($(date +%Y-%m-%d))\""
echo "  git push"
echo ""
