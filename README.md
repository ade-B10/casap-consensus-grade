# Base10 · Casap Consensus Grade

Casap Series B → Series C consensus-deal probability analysis. Internal Base10 use only.

**Live URL**: `https://ade-B10.github.io/casap-consensus-grade/`
...
2. Enter the team password (saved in 1Password under "Base10 · Casap Consensus Grade")
...
```bash
cd /Users/ade/Desktop/Urizen/casap-consensus-grade-deploy

# 1. Drop the updated unencrypted HTML into source/
cp /Users/ade/Desktop/Urizen/Casap_Consensus_Grade.html source/
...
# 3. Commit and push
git add index.html
git commit -m "Refresh Base10 · Casap Consensus Grade ($(date +%Y-%m-%d))"
git push
```
