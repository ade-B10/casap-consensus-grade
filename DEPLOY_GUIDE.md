...
You're deploying to: `https://ade-B10.github.io/casap-consensus-grade/`
Password (save in 1Password under "Base10 · Casap Consensus Grade"): `Base10Automation!`
...
2. Repository name: `casap-consensus-grade`
...
2. In Finder, open `/Users/ade/Desktop/Urizen/casap-consensus-grade-deploy/`
...
`https://github.com/ade-B10/casap-consensus-grade/settings/pages`
...
1. Under "Build and deployment":
   ...
   - **Branch**: `main` / `/ (root)`
2. Click **Save**
3. Wait ~30 seconds. The page will show: "Your site is live at `https://ade-B10.github.io/casap-consensus-grade/`"
...
- Ask in Claude to "update Base10 · Casap Consensus Grade with [the new info]"
- Claude will edit `source/Casap_Consensus_Grade.html`, run `./update.sh`, and tell you the exact commit message
- You just commit + push (or paste the new `index.html` into GitHub web UI)

**DIY path:**
1. Update `source/Casap_Consensus_Grade.html` directly (or have Claude do it)
2. In Terminal: `cd ~/Desktop/Urizen/casap-consensus-grade-deploy && ./update.sh`
